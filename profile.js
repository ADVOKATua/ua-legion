  ...
  async () => {
    ...
    async function loadApplicationStatus() {
      ...
      if (
        ...
        statusDescription =
          "Ваша заявка була схвалена адміністрацією UA LEGION.";
      ...
      if (
        ...
        statusDescription =
          "Ваша остання заявка була відхилена.";
